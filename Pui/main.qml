...
ApplicationWindow {
    ...
    property var cardLayoutByCount: ({
        ...
        6: { columns: 3, rows: 2, scale: 0.84 },
        7: { columns: 3, rows: 3, scale: 0.84 },
        8: { columns: 3, rows: 3, scale: 0.84 },
        9: { columns: 3, rows: 3, scale: 0.84 },
        10: { columns: 3, rows: 4, scale: 0.84 },
        ...
        16: { columns: 4, rows: 4, scale: 0.61 },
        17: { columns: 4, rows: 5, scale: 0.61 },
        18: { columns: 4, rows: 5, scale: 0.61 },
        19: { columns: 4, rows: 5, scale: 0.61 },
        20: { columns: 4, rows: 5, scale: 0.61 },
        ...
        26: { columns: 4, rows: 7, scale: 0.52 },
        27: { columns: 5, rows: 6, scale: 0.52 },
        28: { columns: 5, rows: 6, scale: 0.52 },
        29: { columns: 5, rows: 6, scale: 0.52 },
        30: { columns: 5, rows: 6, scale: 0.52 },
